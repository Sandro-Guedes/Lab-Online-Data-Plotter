...
#
   output$plotAutoLog <- renderPlot({
    ...
    plotAutoLog <- ggplot() +
     ...
     #print(ggplot_build(plotAutoLog)$data)
...
#################################Simple histogram plotter and with mean and standard deviation calculator
  ...
  output$plotHist <- renderPlot({
    ...
    plotHist <- plotHist + 
      ...
      #geom_histogram(binwidth = input$binSize, colour = "black", fill = "light grey", aes(y = ..count..), pad = TRUE)
